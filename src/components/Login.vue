                        ...
                        <div class="login-form">
                            <div class="sign-in-htm">
                                <div class="group">
                                    ...
                                    <input v-model="auth.memberId" id="memberId" type="text" class="input"
                                        placeholder="회원 이름">
                                </div>
                                <div class="group">
                                    <label for="memberPwd" class="label">Password</label>
                                    <input v-model="auth.memberPwd" id="memberPwd" type="password" class="input"
                                        placeholder="전화번호 뒷 4자리">
                                </div>

                                <div class="group mt-5">
                                    <input type="button" class="button" value="로그인"
                                        v-bind:disabled="auth.memberId === '' && auth.memberPwd === ''" @click="login">
                                </div>
                            </div>
                        </div>
                    </form>
